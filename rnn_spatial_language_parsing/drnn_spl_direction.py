...
trainset = LanguageSequenceData('train', 'direction')
testset = LanguageSequenceData('test', 'direction')
...
if __name__ == "__main__":
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, "./model_dir.ckpt")
	...
	save_file = open('test_direction.out', 'w')
	for r in res:
            save_file.write("%d " % r)
        save_file.write("\n")
